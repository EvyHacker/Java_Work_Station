 ...
 * 2019-03-11T19:25:27.466-04:00
 * Generated source version: 3.3.1
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "file:src/test/resources/geoipservice.wsdl",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/test/resources/geoipservice.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:src/test/resources/geoipservice.wsdl");
        }
        WSDL_LOCATION = url;
    }
